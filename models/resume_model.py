    ...
    def get_user_resumes(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                # Fallback: Get all resumes and filter in memory
                ...
                resumes.sort(key=lambda x: x.get('created_at', '1900-01-01'), reverse=True)
    ...
    def get_user_resume_statistics(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'success_rate': round((completed_resumes / total_resumes * 100) if total_resumes > 0 else 0, 2)
            }
