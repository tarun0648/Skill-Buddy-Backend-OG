...
class ProfileAnalysisModel:
    ...
    def get_user_analyses(self, user_id: str, analysis_type: str = None) -> List[Dict[str, Any]]:
        """Get all analyses for a user, optionally filtered by type"""
        try:
            ...
            try:
                ...
                for doc in docs:
                    ...
                    analysis_summary = {
                        ...
                        'profile_url': analysis_data.get('profile_url'),
                        'github_username': analysis_data.get('github_username'),
                        'has_results': bool(analysis_data.get('analysis_results_json') or analysis_data.get('suggestions_json'))
                    }
    ...
    def get_user_analysis_statistics(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for doc in docs:
                ...
                if status == 'completed':
                    ...
                    if analysis_data.get('grade'):
                        total_grade += analysis_data.get('grade', 0)
            ...
            return {
                ...
                'average_grade': round(total_grade / completed_analyses, 1) if completed_analyses > 0 else 0,
